    ...
    render: function() {
        ...
        function drawGameButton(name, x, y, href) {
            ...
            var img = new Kinetic.Image({
                ...
                y: 10,
                x: 10,
                width: bg.getWidth() - 20,
                height: bg.getHeight() - 20
            })
            grp.add(img)
        ...
        var offset = { x: 0, y: 320 }
        , spacer = { x: 360, y: 200 }
        , perLine = 3
        , n = 0

        function addButton(img, href) {
            drawGameButton(
                img,
                offset.x + spacer.x * (n % perLine),
                offset.y + spacer.y * Math.floor(n / perLine),
                href
            )
        ...
        addButton('job', '#jacks-or-better')
        addButton('rwb', '#red-white-and-blue')
        addButton('bj', '#blackjack/bj1')
        addButton('bj', '#blackjack/bj2')
