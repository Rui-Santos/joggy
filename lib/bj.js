...
, bj = module.exports = {
    ...
    settle: function(splits, hand, dealer, dealerStanding) {
        var playerBj = !splits && bj.isBlackjack(hand)
        , dealerBj = bj.isBlackjack(dealer);
        if (playerBj) return dealerBj ? 1 : 2.5
    ...
    values: function(hand) {
        return _.map(hand, function(card) { return bj.value(card) })
    },
