...
, symbols = {
    ...
    'apple': ['apple'],
    'banana': ['banana'],
    'bill-clinton': ['clinton', 'pres clinton'],
    'bitcoin': ['btc', 'bitcoin'],
    ...
    'flower': ['flower'],
    // typo
    'hamurger': ['hamburger', 'burger'],
    'helicopter': ['copter', 'helicopter'],
    'henry-ford': ['ford', 'henry ford', 'henry'],
    'homer': ['homer', 'mr simpson', 'simpson'],
    'kitten': ['kitten', 'cat', 'kitty', 'kit'],
    'marie-curie': ['curie', 'marie curie', 'marie'],
    'motorcycle': ['bike', 'motorcycle'],
    'niels': ['bohr', 'niels', 'niels bohr'],
    'nikola': ['tesla', 'nikola', 'nikola tesla'],
    'obama': ['obama', 'pres obama'],
    'plane': ['plane', 'airplane'],
    'puppy': ['pup', 'puppy', 'lil puppy'],
    'santa': ['santa', 'santaclaus'],
