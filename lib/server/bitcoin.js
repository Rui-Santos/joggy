...
function Bitcoin() {
    BitcoinClient.call(this, config.BTC)
...
Bitcoin.prototype.processOutput = function(o, txid) {
    ...
    return Q.ninvoke(db.get('users'), 'findAndModify', options).then(function(user) {
        if (!user) {
...
Bitcoin.prototype.processNewBlocks = function() {
    ...
    return Q.all([
        Q.ninvoke(db.get('bitcoin.blocks'), 'findOne', { }, { sort: { height: -1 } }),
        ...
        .then(function(hash) {
            ...
            .then(function() {
                return Q.ninvoke(db.get('bitcoin.blocks'), 'insert', {
                    _id: hash,
                    height: nextHeight
                })
            })
