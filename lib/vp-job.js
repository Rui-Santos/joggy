...
, job = module.exports = {
    ...
    payouts: {
        '9-6': {
            1: [1 * 1, 1 * 2, 1 * 3, 1 * 4, 1 * 6, 1 * 9, 1 * 25, 1 * 50, 1 * 250],
            2: [2 * 1, 2 * 2, 2 * 3, 2 * 4, 2 * 6, 2 * 9, 2 * 25, 2 * 50, 2 * 250],
            3: [3 * 1, 3 * 2, 3 * 3, 3 * 4, 3 * 6, 3 * 9, 3 * 25, 3 * 50, 3 * 250],
            4: [4 * 1, 4 * 2, 4 * 3, 4 * 4, 4 * 6, 4 * 9, 4 * 25, 4 * 50, 4 * 250],
